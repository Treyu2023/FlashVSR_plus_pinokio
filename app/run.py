...
parser.add_argument("--tile-size", type=int, default=320, help="Chunk size of tile inference, default=320")
parser.add_argument("--overlap", type=int, default=32, help="Overlap size of tile inference, default=32")
